...
% Get date range
today = datetime('now')
begin_date = dateshift(min(d.Start), 'start', 'year')
end_date = dateshift(today, 'start', 'year', 'next')
...
current_roster = sum(isnat(d.Stop))
...
current_roster = current_roster + (5-mod(current_roster,5));
y_ticks = [0 current_roster];
